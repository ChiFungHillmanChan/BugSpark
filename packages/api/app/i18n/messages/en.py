...
MESSAGES: dict[str, str] = {
    ...
    "auth.google_not_enabled": "Google sign-in is not enabled",
    "auth.google_not_linked": "No Google account is linked",
    "auth.google_unlink_needs_password": "Please set a password before unlinking your Google account",
    "auth.google_unlinked": "Google account unlinked successfully",
    "auth.google_already_linked": "This Google account is already linked to another user",
    "auth.no_password_set": "No password is set on this account",
    "auth.password_already_set": "A password is already set on this account",
    ...
    "plan.team_member_limit": "Plan limit reached: your plan allows up to {limit} team member(s) per project. Please upgrade your plan.",
}
