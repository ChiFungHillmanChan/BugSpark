...
MESSAGES: dict[str, str] = {
    ...
    "auth.google_not_enabled": "Google 登入功能尚未啟用",
    "auth.google_not_linked": "尚未連結 Google 帳號",
    "auth.google_unlink_needs_password": "請先設定密碼再取消連結 Google 帳號",
    "auth.google_unlinked": "已成功取消連結 Google 帳號",
    "auth.google_already_linked": "此 Google 帳號已連結至其他使用者",
    "auth.no_password_set": "此帳號尚未設定密碼",
    "auth.password_already_set": "此帳號已設定密碼",
    "auth.password_set": "密碼設定成功",
    # Tokens
