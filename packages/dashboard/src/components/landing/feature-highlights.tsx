...
export function FeatureHighlights() {
  ...
  return (
    <section id="features" className="py-20 sm:py-28 bg-white dark:bg-navy-950 cv-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {FEATURES.map((feature) => (
            <div
              ...
              className="group p-6 rounded-2xl border border-gray-200 dark:border-white/[0.08] dark:bg-navy-800/50 dark:backdrop-blur-sm hover:border-accent/30 dark:hover:border-white/[0.15] hover:shadow-lg dark:hover:shadow-accent/5 hover:-translate-y-0.5 transition-all [will-change:transform]"
            >
